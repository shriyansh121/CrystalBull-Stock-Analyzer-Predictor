...
import datetime
import ta
from pages.utils.plotly_figure import plotly_table,candlestick, close_chart, filter_data, RSI, MACD, Moving_average
...
with col2:
    if chart_type == 'Candle':
        ...
        indicators = st.selectbox('',('RSI', 'Maving Average', 'MACD'))
